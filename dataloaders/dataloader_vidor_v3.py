...
class Dataset(object):
    def __init__(self,split,video_dir,ann_dir,proposal_dir,classeme_dir,cache_tag,
        max_proposal,max_preds,score_th,dim_boxfeature,min_frames_th,video_feature_dir=None
    ):
        self.max_proposal = max_proposal
        self.max_preds = max_preds
